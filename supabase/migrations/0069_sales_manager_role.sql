-- Add sales_manager as a supported profile role and management-equivalent permission preset.
...
begin
  ...
  if v_role in ('employee', 'apprentice', 'team_member_1', 'team_member_2', 'team_lead_1', 'team_lead_2') then
  ...
  elsif v_role in ('office_admin', 'owner', 'operations_manager', 'sales_manager') then
    v_preset := p_perm in (
      'vehicles.view',
      'equipment.view',
      'maintenance.view',
